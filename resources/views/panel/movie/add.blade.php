    ...
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-movie" method="post" action="{{ route('panel.store.add.movie') }}">
            @csrf
            <div class="form-group">
              <label for="tmdb_id"> TMDB ID </label>
              <input type="text" class="form-control" name="tmdb_id" value="{{ old('tmdb_id') }}" placeholder="Enter Movie TMDB ID">
            </div>
            <div class="form-group">
              <label for="movie_code"> Movie Code </label>
              <input type="text" class="form-control" name="movie_code" value="{{ old('movie_code') }}" placeholder="Enter Movie Code ">
            </div>
            {{-- <div class="form-group">
